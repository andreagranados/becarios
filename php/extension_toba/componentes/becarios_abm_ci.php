<?php
class becarios_abm_ci extends toba_ci
{
...
//          print_r($bandera);exit;
          ...
          $datos_adj=$this->dep('datos')->tabla('inscripcion_adjuntos')->get_datos_adjuntos($inscripcion['id_becario'],$inscripcion['id_conv']);          
          //print_r($bandera);exit;
          $datos_proy=$this->dep('datos')->tabla('proyecto_inv')->get_datos_proyecto($inscripcion['id_proyecto']);
          $datos_insc=$this->dep('datos')->tabla('inscripcion_beca')->get_datos_inscripcion($inscripcion['id_becario'],$inscripcion['id_conv']);
          ...
          //if($bandera=='imprimir1'){//imprimir el formulario
            ...
            $formato = utf8_decode('Convocatoria Becas de Investigación - '.$this->s__leyenda.'   '.date('d/m/Y h:i:s a').'     Página {PAGENUM} de {TOTALPAGENUM} ');
            ...
            $datos_estudio=$this->dep('datos')->tabla('becario_estudio')->get_datos_estudio($inscripcion['id_becario'],$inscripcion['id_conv']); 
            $datos_beca=$this->dep('datos')->tabla('becario_beca')->get_datos_beca($inscripcion['id_becario'],$inscripcion['id_conv']); 
            $datos_empleo_actual=$this->dep('datos')->tabla('becario_empleo')->get_empleos(true,$inscripcion['id_becario'],$inscripcion['id_conv']); 
            $datos_empleo_anterior=$this->dep('datos')->tabla('becario_empleo')->get_empleos(false,$inscripcion['id_becario'],$inscripcion['id_conv']); 
            $datos_pi=$this->dep('datos')->tabla('participacion_inv')->get_datos_pi($inscripcion['id_becario'],$inscripcion['id_conv']); 
            //print_r($datos_pi);exit;
            $datos_pe=$this->dep('datos')->tabla('participacion_ext')->get_datos_pe($inscripcion['id_becario'],$inscripcion['id_conv']); 
            $datos_disti=$this->dep('datos')->tabla('becario_distincion')->get_datos_distincion($inscripcion['id_becario'],$inscripcion['id_conv']); 
            $datos_trab=$this->dep('datos')->tabla('becario_trabajo')->get_datos_trabajo($inscripcion['id_becario'],$inscripcion['id_conv']); 
            $datos_idioma=$this->dep('datos')->tabla('becario_idioma')->get_datos_idioma($inscripcion['id_becario'],$inscripcion['id_conv']); 
