<?php
 class tp_becarios extends toba_tp_basico
  ...
  protected $clase_encabezado = 'encabezado';	
	...
	{ 
            ...
            //echo "<div>".toba_recurso::imagen_proyecto('logo_becarios.png', true,'220','200')."</div>";
            echo "<div>".toba_recurso::imagen_proyecto('logo_becarios.png', true,'180','100')."</div>";
            echo "<br>";
	...
	function post_contenido()
	{
		...
		echo "<div class='login-pie'>";
                echo "<div> <a href='https://docs.google.com/forms/d/e/1FAIpQLScrPL0lw1JdN_I88ZyuqYehLzZYNEey4lFCA6gMGmI5Oe5QIA/viewform?usp=sf_link'>Solicitud Usuario</a>" ."</div>";
                echo "<br>";
                $anio=date('Y');
