...
INSERT INTO apex_objeto_ci_pantalla (objeto_ci_proyecto, objeto_ci, pantalla, identificador, orden, etiqueta, descripcion, tip, imagen_recurso_origen, imagen, objetos, eventos, subclase, subclase_archivo, template, template_impresion, punto_montaje) VALUES (
	...
	'7', --etiqueta
	'DATOS ADJUNTOS<br>
No permite cargar archivos .PDF que superen los 5MB. En caso de que alguno de los archivos exceda ese tamaño se sugiere comprimirlo usando alguna herramienta online, por ejemplo <a href=" http://www.ilovepdf.com/es/comprimir_pdf" target="nueva"> ww.ilovepdf.com/es/comprimir_pdf</a>', --descripcion
	NULL, --tip
	'apex', --imagen_recurso_origen
	NULL, --imagen
	NULL, --objetos
