...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'becarios', --objeto_cuadro_proyecto
	'4227', --objeto_cuadro
	'4388', --objeto_cuadro_col
	'fec_inicio_ua', --clave
	'5', --orden
	'Fecha Inicio UA', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'7', --estilo
	NULL, --ancho
	'8', --formateo
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'becarios', --objeto_cuadro_proyecto
	'4227', --objeto_cuadro
	'4390', --objeto_cuadro_col
	'fec_ver_asignadas', --clave
	'7', --orden
	'Fecha Ver Asignadas', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'7', --estilo
	NULL, --ancho
	'8', --formateo
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'becarios', --objeto_cuadro_proyecto
	'4227', --objeto_cuadro
	'4794', --objeto_cuadro_col
	'inicio', --clave
	'3', --orden
	'Inicio Inscripciones', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'7', --estilo
	NULL, --ancho
	'8', --formateo
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'becarios', --objeto_cuadro_proyecto
	'4227', --objeto_cuadro
	'4795', --objeto_cuadro_col
	'fin', --clave
	'4', --orden
	'Fin Inscripciones', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'7', --estilo
	NULL, --ancho
	'8', --formateo
